    ...
    <div class="am-container">
        ...
        <div class="am-collapse am-topbar-collapse" id="doc-topbar-collapse">
            <ul class="am-nav am-nav-pills am-topbar-nav">
                <li class="@if($currentRouteName == 'host.index')am-active @endif "><a href="{{ route('host.index') }}">首页</a></li>
                <li class="am-dropdown" data-am-dropdown>
                    ...
                    <ul class="am-dropdown-content">
                        ...
                        @forelse($enableGroups as $group)
                            <li class="@if(isset($enableGroup) && $enableGroup->id == $group->id)am-active @endif "><a href="{{ route('host.work.group.show', [$group->id]) }}">{{ $group->display_name }}</a></li>
                        @empty
            ...
            <div class="am-topbar-right">
                <div class="am-dropdown" data-am-dropdown="{boundary: '.am-topbar'}">
                    <button class="am-btn am-btn-secondary am-topbar-btn am-btn-sm am-dropdown-toggle" data-am-dropdown-toggle><i class="am-icon-user"></i> 您好 {{ Auth::user()->name }} <span class="am-badge am-badge-warning am-round sf-float-badge">10</span></button>
                    <ul class="am-dropdown-content">
                        <li><a href="#">我的消息 <span class="am-badge am-badge-warning am-round">10</span></a></li>
                        <li><a href="#">我的工单</a></li>
                        <li class="am-divider"></li>
