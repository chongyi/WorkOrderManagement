            ...
            <div class="am-panel am-panel-primary">
                ...
                <div class="am-panel-bd">
                    ...
                    <form class="am-form" method="post"
                          action="{{ route('host.work.group.work-order.index', $enableGroup->id) }}">
                        {{ csrf_field() }}
                        ...
                        <div class="am-form-group">
                            ...
                            <input type="text" class="" id="work-group" value="{{ $enableGroup->display_name }}" disabled="disabled">
                        </div>
                        ...
                        <a href="{{ route('host.work.group.show', [$enableGroup->id]) }}" class="am-btn am-btn-default">取消</a>
                    </form>
                </div>
            </div>
        </div>
